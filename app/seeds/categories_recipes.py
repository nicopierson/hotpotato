...
def seed_categories():
    ...
    categories = [
        ...
        ["thai", "https://www.thespruceeats.com/thmb/Z4Zw3CXSODsNHx3iahdpwk5mnwY=/960x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/ThaiRiceNoodleSaladWithChili-LimeVinaigrette-TheSpruce_MaxwellCozzi-33e799b9fd0249b9926ef44c0467b93f.jpg"],
        ["japanese", "https://www.thespruceeats.com/thmb/q-pP7iP8SuhAJ15NtsE7WYf3uxM=/2308x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/sushi-rice-recipe-2031498-step-10-87501cf6391548538deee6a8cf012f03.jpg"],
        ...
        ["greek", "https://www.thespruceeats.com/thmb/PG5No8q5PwKdwvrAv9e3PMPmgbA=/960x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/GreekSpinachPieSpanakopita-TheSpruceEats-cc27326c734a4fa98c041b49bf7ea676.jpg"],
