  ...
  return (
    <div className="recipe-card-wrapper">
      <div className="recipe-elements-container">
        ...
        {/* image */}
        <div style={{backgroundImage: `url(${thumbnail_url? thumbnail_url: default_image_url})`, height:'100%', width:'100%', 'background-repeat':'no-repeat', 'background-size':'cover', 'object-fit': 'cover' }} className="recipe-card">
